...
<nav>
	...
	<div grid class="corps">
		...
		<div column="8 +2">
			...
			<?php echo form_open('Sign_Controller/password_forgotten'); ?>
				<fieldset>
					<legend>Récuperation de votre mot de passe</legend>
						<label>Login
							<input type="text" name="login" pattern="[0-9a-zA-ZàâæçéèêëîïôœùûüÿÀÂÆÇnÉÈÊËÎÏÔŒÙÛÜŸ \s-]+" title="N'utilisez pas de caractères spéciaux" placeholder="Login*" <?php if(isset($login)) echo 'value="'.$login.'"';?>>
						</label>
