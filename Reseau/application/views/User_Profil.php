...
<nav>
	...
	<ul>
			...
			<li><a href="<?php echo base_url('user/profil');?>" class="active"> 👤 Mon profil</a></li>
	...
	<article>
		<center><i>Informations relatives à votre compte </i></center>
		<ul class="informations">

			<center><li><span>Login : </span><?php echo $login;?></li></center>
			<center><li><span>Prénom : </span><?php echo $firstname;?></li></center>
			<center><li><span>Nom : </span><?php echo $lastname;?></li></center>
			<center><li><span>Date de création de compte : </span><?php echo $date;?></li></center>
